...
class DeveloperPreview {
    ...
    let statistic1 = StatisticsModel(title: "Market Cap", value: "$2.56Tr")
    let statistic2 = StatisticsModel(title: "24h Volume", value: "$338.83Bn", percentageChange: 0.06)
    let statistic3 = StatisticsModel(title: "BTC Dominance", value: "42.67%n")
    let statistic4 = StatisticsModel(title: "Portfolio Value", value: "67.67%n", percentageChange: -0.5)
